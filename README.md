...
- **Does not encode repeated frames**: an hour of a still screen does not weigh
  like an hour of video. And it can **compress the recording afterwards**, by
  CPU, without changing format.
